...
import { columns } from "./kanban-table-columns";
...
export function KanbanTable({ data, onDeleteTask, onDuplicateTask, onUpdateTask }: KanbanTableProps) {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-xl border border-border/70 bg-background">
      ...
      <div className="flex shrink-0 flex-col gap-3 border-t px-4 py-4 md:flex-row md:items-center md:justify-between">
